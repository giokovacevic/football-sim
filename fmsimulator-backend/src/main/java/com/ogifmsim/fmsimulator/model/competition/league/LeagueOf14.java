...
public class LeagueOf14 extends League {

    public LeagueOf14(String id, String name, int cicle, int round, String parentLeagueId, int relegation, Schedule schedule) {
        super(id, name, cicle, round, parentLeagueId, relegation, schedule);
        this.competitors = new ArrayList<>(14);
        //schedule
    }
