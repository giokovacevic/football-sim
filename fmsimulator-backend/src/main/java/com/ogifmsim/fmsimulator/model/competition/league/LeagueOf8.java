...
public class LeagueOf8 extends League {

    public LeagueOf8(String id, String name, int cicle, int round, String parentLeagueId, int relegation, Schedule schedule) {
        super(id, name, cicle, round, parentLeagueId, relegation, schedule);
        this.competitors = new ArrayList<>(8);
        //schedule
    }
